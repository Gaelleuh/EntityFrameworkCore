...
internal static class IHM
{
    ...
    private static void TaperPersonnage()
    {
        ...
        if (personnage1.PointsDeVie <= 0 && personnage2.PointsDeVie <= 0)
        {
            ...
            Console.WriteLine("Les deux Players sont morts!");
        }
        else if (personnage1.PointsDeVie<=0)
        {
            context.Personnages.Remove(personnage1);
            personnage2.NombrePersonneTues++;
            Console.WriteLine("Player 1 est mort!");
        }
        else 
        {
            context.Personnages.Remove(personnage2);
            personnage1.NombrePersonneTues++;
            Console.WriteLine("Player 2 est mort!");
        }
